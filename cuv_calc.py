...
def _compute_derivatives(nlon, nlat, lon, lat, ut, vt, dux, duy, dvx, dvy, dtopo, pi, ddeg):
    """
    ...
    for ilat in range(1, nlat-1):
        ...
        for ilon in range(1, nlon-1):
            ...
            dtopo[ilat, ilon] = ut[ilat, ilon] + ut[ilat, ilon-1] + ut[ilat, ilon+1] + ut[ilat-1, ilon] + ut[ilat+1, ilon]
        ...
        # dtopo at boundaries
        dtopo[ilat, 0] = ut[ilat, 0] + ut[ilat, nlon-1] + ut[ilat, 1] + ut[ilat-1, 0] + ut[ilat+1, 0]
        dtopo[ilat, nlon-1] = ut[ilat, nlon-1] + ut[ilat, nlon-2] + ut[ilat, 0] + ut[ilat-1, nlon-1] + ut[ilat+1, nlon-1]
...
# Run the function
cvort, cuv, tp = cuv_calc(lon, lat, ut, vt)
"""
